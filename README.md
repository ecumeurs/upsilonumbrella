...
| [GDPR account deletion never reaches economy — credits, ledgers and inventory survive erasure](issues/ISS-165_20260917_gdpr_erasure_never_reaches_economy.md) | 2026-09-17 | Open | High | `upsiloneconomy` implements a correct, idempotent GDPR purge — `PG.Purge` zer... |
